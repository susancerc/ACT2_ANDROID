  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      body: Container(
        ...
        decoration: BoxDecoration(color: Colors.yellow[200], image: DecorationImage(image: NetworkImage("https://raw.githubusercontent.com/susancerc/mis_imagenes/main/animalcrrr.jpg"), alignment: Alignment.topCenter) //fin de decoration image
            ), //fin box decoration
